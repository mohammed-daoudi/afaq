...
export function WorldMap({ 
  ...
  const svgMap = useMemo(
    () => map.getSVG({
      radius: 0.22,
      color: theme === "dark" ? "#FFFF7F40" : "#133b3a40",
      shape: "circle",
  ...
  return (
    <div className="w-full aspect-[2/1] md:aspect-[2.5/1] lg:aspect-[2/1] dark:bg-black bg-transparent rounded-lg relative overflow-hidden">
      <Image
