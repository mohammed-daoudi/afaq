...
interface CardProps {
  ...
  title: string;
  description: string;
  colorTheme?: "orange" | "blue" | "purple" | "teal" | "gold" | "red";
  className?: string;
  rotate?: string;
  colors?: {
    bg: string;
...
const Card = ({
  ...
  const defaultTextColors = {
    ...
    teal: "text-[#133b3a] dark:text-teal-400",
    gold: "text-[#d9a05b] dark:text-amber-400",
    red: "text-[#df1e26] dark:text-red-400",
  };
  const defaultBorderColors = {
    ...
    teal: "border-[#133b3a]/20 dark:border-teal-500/20",
    gold: "border-[#d9a05b]/20 dark:border-amber-500/20",
    red: "border-[#df1e26]/20 dark:border-red-500/20",
  };
    ...
    >
      <div className="bg-white dark:bg-neutral-900 p-2 rounded-[25px] shadow-[0px_10px_20px_0px_#D3D3D3] dark:shadow-none border border-neutral-100 dark:border-neutral-800">
        ...
        >
          ...
          <h3 className="text-xl font-bold text-neutral-800 dark:text-neutral-100 leading-tight mb-[10px]">
            {title}
          </h3>
...
export default function HowItWorks({
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div
        className={`bg-transparent relative ${className}`}
      >
        <div className="max-w-6xl mx-auto relative z-10 py-10 md:py-20">
          <div
