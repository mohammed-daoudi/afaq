        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            <motion.h1 variants={fadeUp} className="text-5xl md:text-6xl font-heading font-extrabold text-teal-deep leading-tight">
              {t('titleLine1')} <br /><span className="text-gold-soft italic font-serif font-light">{t('titleLine2')}</span>
            </motion.h1>
          ...
          >
            <Image
              src="/images/unsplash/comp/Gemini_Generated_Image_x71gg6x71gg6x71g.jfif"
        ...
        <div className="max-w-5xl mx-auto mb-16">
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className={`px-6 py-3 rounded-full text-sm font-bold tracking-wide transition-all duration-300 ${activeFamily === 'all'
            ...
            {THERAPEUTIC_FAMILIES.map((family) => {
              ...
              return (
                <button
                  ...
                  className={`px-6 py-3 rounded-full text-sm font-bold tracking-wide transition-all duration-300 ${isActive
