  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h1 className="text-3xl font-bold text-teal-deep">Catalogue & Commandes</h1>
          <p className="text-anthracite-soft/60 mt-1">Gérez vos approvisionnements avec vos tarifs négociés (PPH).</p>
        </div>
        <button 
          onClick={() => setIsOpen(true)}
          className="flex items-center gap-2 bg-teal-deep text-white px-6 py-3 font-bold rounded-xl hover:bg-gold-soft hover:text-teal-deep transition-all shadow-md shimmer-effect"
        >
            ...
            <div key={product.id} className="bg-white rounded-3xl shadow-sm hover:shadow-lg transition-shadow border border-sage-light flex flex-col overflow-hidden group">
              <div className="p-6 flex-grow flex flex-col">
                ...
                <div className="mb-2 flex-grow">
                  ...
                  <h3 className="font-bold text-lg text-teal-deep leading-tight">{product.name}</h3>
              ...
              <button 
                ...
                className="w-full bg-sage-light text-teal-deep font-bold py-3.5 text-sm flex items-center justify-center gap-2 rounded-xl hover:bg-gold-soft hover:text-teal-deep transition-all shadow-md shimmer-effect"
              >
